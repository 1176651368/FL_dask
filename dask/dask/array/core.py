...
class Array(DaskMethodsMixin):
    ...
    def __new__(cls, dask, name, chunks, dtype=None, meta=None, shape=None, public_key=None, ciphertext=None,
                exponent=None):
...
def new_da_object(dsk, name, chunks, meta=None, dtype=None,
    ...
    if is_dataframe_like(meta) or is_series_like(meta) or is_index_like(meta):
        ...
        return Array(dsk, name=name, chunks=chunks, meta=meta, dtype=dtype, public_key=public_key,
                     ciphertext=ciphertext, exponent=exponent)
