...
class Array(DaskMethodsMixin):
    ...
    __slots__ = "dask", "__name", "_cached_keys", "__chunks", "_meta", "__dict__", 'public_key', 'ciphertext', 'exponent'


    def __new__(cls, dask, name, chunks, dtype=None, meta=None, shape=None, public_key=None,ciphertext=None,exponent=None):
    ...
    def set_cip_attribute(self, cip):
        cip.exponent = self.exponent
        cip.ciphertext = self.ciphertext
        cip.public_key = self.public_key
        return cip

    @check_if_handled_given_other
    def __add__(self, other):
        m = self.set_cip_attribute(elemwise(operator.add, self, other))
        return m

    @check_if_handled_given_other
    def __radd__(self, other):
        return self.set_cip_attribute(elemwise(operator.add, other, self))

    @check_if_handled_given_other
    def __and__(self, other):

        return self.set_cip_attribute(elemwise(operator.and_, self, other))

    @check_if_handled_given_other
    def __rand__(self, other):
        return self.set_cip_attribute(elemwise(operator.and_, other, self))

    @check_if_handled_given_other
    def __div__(self, other):
        return self.set_cip_attribute(elemwise(operator.div, self, other))

    @check_if_handled_given_other
    def __rdiv__(self, other):
        return self.set_cip_attribute(elemwise(operator.div, other, self))

    @check_if_handled_given_other
    def __eq__(self, other):
        return self.set_cip_attribute(elemwise(operator.eq, self, other))

    @check_if_handled_given_other
    def __gt__(self, other):
        return self.set_cip_attribute(elemwise(operator.gt, self, other))

    @check_if_handled_given_other
    def __ge__(self, other):
        return self.set_cip_attribute(elemwise(operator.ge, self, other))

    def __invert__(self):
        return self.set_cip_attribute(elemwise(operator.invert, self))

    @check_if_handled_given_other
    def __lshift__(self, other):
        return self.set_cip_attribute(elemwise(operator.lshift, self, other))

    @check_if_handled_given_other
    def __rlshift__(self, other):
        return self.set_cip_attribute(elemwise(operator.lshift, other, self))

    @check_if_handled_given_other
    def __lt__(self, other):
        return self.set_cip_attribute(elemwise(operator.lt, self, other))

    @check_if_handled_given_other
    def __le__(self, other):
        return self.set_cip_attribute(elemwise(operator.le, self, other))

    @check_if_handled_given_other
    def __mod__(self, other):
        return self.set_cip_attribute(elemwise(operator.mod, self, other))

    @check_if_handled_given_other
    def __rmod__(self, other):
        return self.set_cip_attribute(elemwise(operator.mod, other, self))

    @check_if_handled_given_other
    def __mul__(self, other):
        return self.set_cip_attribute(elemwise(operator.mul, self, other))

    @check_if_handled_given_other
    def __rmul__(self, other):
        return self.set_cip_attribute(elemwise(operator.mul, other, self))

    @check_if_handled_given_other
    def __ne__(self, other):
        return self.set_cip_attribute(elemwise(operator.ne, self, other))

    def __neg__(self):
        return self.set_cip_attribute(elemwise(operator.neg, self))

    @check_if_handled_given_other
    def __or__(self, other):
        return self.set_cip_attribute(elemwise(operator.or_, self, other))
    ...
    def __ror__(self, other):
        return self.set_cip_attribute(elemwise(operator.or_, other, self))

    @check_if_handled_given_other
    def __pow__(self, other):
        return self.set_cip_attribute(elemwise(operator.pow, self, other))

    @check_if_handled_given_other
    def __rpow__(self, other):
        return self.set_cip_attribute(elemwise(operator.pow, other, self))

    @check_if_handled_given_other
    def __rshift__(self, other):
        return self.set_cip_attribute(elemwise(operator.rshift, self, other))

    @check_if_handled_given_other
    def __rrshift__(self, other):
        return self.set_cip_attribute(elemwise(operator.rshift, other, self))

    @check_if_handled_given_other
    def __sub__(self, other):
        return self.set_cip_attribute(elemwise(operator.sub, self, other))

    @check_if_handled_given_other
    def __rsub__(self, other):
        return self.set_cip_attribute(elemwise(operator.sub, other, self))

    @check_if_handled_given_other
    def __truediv__(self, other):
        return self.set_cip_attribute(elemwise(operator.truediv, self, other))

    @check_if_handled_given_other
    def __rtruediv__(self, other):
        return self.set_cip_attribute(elemwise(operator.truediv, other, self))

    @check_if_handled_given_other
    def __floordiv__(self, other):
        return self.set_cip_attribute(elemwise(operator.floordiv, self, other))

    @check_if_handled_given_other
    def __rfloordiv__(self, other):
        return self.set_cip_attribute(elemwise(operator.floordiv, other, self))

    @check_if_handled_given_other
    def __xor__(self, other):
        return self.set_cip_attribute(elemwise(operator.xor, self, other))

    @check_if_handled_given_other
    def __rxor__(self, other):
        return self.set_cip_attribute(elemwise(operator.xor, other, self))

    @check_if_handled_given_other
    def __matmul__(self, other):
        from dask.array.routines import matmul

        return self.set_cip_attribute(matmul(self, other))

    @check_if_handled_given_other
    def __rmatmul__(self, other):
        from dask.array.routines import matmul

        return self.set_cip_attribute(matmul(other, self))

    @check_if_handled_given_other
    def __divmod__(self, other):
        from dask.array.ufunc import divmod

        return self.set_cip_attribute(divmod(self, other))
...
def handle_out(out, result):
    ...
    if isinstance(out, Array):
        ...
        out.exponent = result.exponent
        out.ciphertext = result.ciphertext
        out.public_key = result.public_key
...
def new_da_object(dsk, name, chunks, meta=None, dtype=None,
                  public_key = None, ciphertext = None, exponent =  None):
    ...
    if is_dataframe_like(meta) or is_series_like(meta) or is_index_like(meta):
        ...
        return Array(dsk, name=name, chunks=chunks, meta=meta, dtype=dtype,public_key=public_key,ciphertext=ciphertext,exponent=exponent)
